...
<?php 
  ...
  {
    header("location: productos_destacados.php");
  }
...
?>
        ...
        <?php
          ...
          //paginador
          $sql_totales = $link->query("SELECT COUNT(*) as total_registro FROM productos WHERE destacado=1");
...
$consulta="SELECT * FROM productos WHERE destacado=1";
