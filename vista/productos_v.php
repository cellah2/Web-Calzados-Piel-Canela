...
<html>
	...
	<body class="is-preload">
      ...
      <div class="product-box"> 
        ...
        <?php  while($title=$categorias->fetch_object()): ?>   
          <h1>Categoria : <?php echo $title->nombre_categoria; ?></h1>
          <?php endwhile; ?>
                </div>
      <?php  while($cat=$productoCat->fetch_object()): ?>   
		...
		<div class="product-box__items">
			...
			<div class="categorias-aside">
				...
				<div class="categorias-aside__opciones">
					<ul>
					<ul>
					<?php  while($cat=$allCategorias->fetch_object()): ?>   
